...
(function(){
    ...
    var Recorder = function(params){
        ...
        this.connect = function(){
            //-b 900k -vcodec copy -r 60 -y
            this.readStream = child_process.spawn("ffmpeg",["-rtsp_transport", "tcp", "-i", this.url, '-f', 'mpeg', '-b:v', '800k', '-r', '30', '-'],{detached: false});
            // this.readStream = child_process.spawn("ffmpeg",["-rtsp_transport", "tcp", "-i", this.url, '-f', 'mpeg1video', '-b:v', '800k', '-r', '30', '-'],{detached: false});
            // this.readStream = child_process.spawn("ffmpeg",["-i", this.url, '-b', '900k', 'vcodec', 'copy', '-r', '60', '-'],{detached: false});
